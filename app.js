...
var _user$project$Common$fromJust = function (x) {
	var _p0 = x;
	if (_p0.ctor === 'Just') {
		return _p0._0;
	} else {
...
var _user$project$Lambda$equivalent = F2(
	function (x, y) {
		equivalent:
		while (true) {
			...
			do {
				switch (_p0._0.ctor) {
					case 'DLit':
						if (_p0._0._0.ctor === 'LInt') {
							if ((_p0._1.ctor === 'DLit') && (_p0._1._0.ctor === 'LInt')) {
								return _elm_lang$core$Native_Utils.eq(_p0._0._0._0, _p0._1._0._0);
							} else {
								break _v0_5;
							}
						} else {
							if ((_p0._1.ctor === 'DLit') && (_p0._1._0.ctor === 'LBool')) {
								return _elm_lang$core$Native_Utils.eq(_p0._0._0._0, _p0._1._0._0);
							} else {
								break _v0_5;
							}
					...
					default:
						if (_p0._1.ctor === 'DApp') {
							return A2(_user$project$Lambda$equivalent, _p0._0._0, _p0._1._0) && A2(_user$project$Lambda$equivalent, _p0._0._1, _p0._1._1);
						} else {
							break _v0_5;
						}
				}
...
var _user$project$Lambda$genName = function (n) {
	var name = _elm_lang$core$Char$fromCode(
		A2(_elm_lang$core$Basics_ops['%'], n, 26) + _elm_lang$core$Char$toCode(
			_elm_lang$core$Native_Utils.chr('a')));
	return (_elm_lang$core$Native_Utils.cmp(n, 26) < 0) ? _elm_lang$core$String$fromChar(name) : A2(
		_elm_lang$core$String$cons,
		name,
		_user$project$Lambda$genName((n / 26) | 0));
};
var _user$project$Lambda$mkNewName = function (n) {
	return (_elm_lang$core$Native_Utils.cmp(n, 26) < 0) ? _elm_lang$core$String$fromChar(
		_user$project$Common$fromJust(
			A2(
				_elm_community$list_extra$List_Extra_ops['!!'],
				_elm_lang$core$String$toList('xyzuvwabcdefghijklmnopqrst'),
				n))) : _user$project$Lambda$genName(n);
};
var _user$project$Lambda_ops = _user$project$Lambda_ops || {};
_user$project$Lambda_ops['<$>'] = F2(
	function (f, m) {
		var _p1 = m;
		if (_p1.ctor === 'Just') {
			return _elm_lang$core$Maybe$Just(
...
_user$project$Lambda_ops['<*>'] = F2(
	function (mf, ma) {
		var _p2 = mf;
		if (_p2.ctor === 'Just') {
			return A2(_user$project$Lambda_ops['<$>'], _p2._0, ma);
		} else {
			return _elm_lang$core$Maybe$Nothing;
		}
	});
var _user$project$Lambda$Lit = function (a) {
	return {ctor: 'Lit', _0: a};
};
var _user$project$Lambda$Lam = F2(
	function (a, b) {
		return {ctor: 'Lam', _0: a, _1: b};
	});
var _user$project$Lambda$App = F2(
	function (a, b) {
		return {ctor: 'App', _0: a, _1: b};
	});
var _user$project$Lambda$Var = function (a) {
	return {ctor: 'Var', _0: a};
};
var _user$project$Lambda$toExpr = F2(
	function (ctx, e) {
		var _p3 = e;
		switch (_p3.ctor) {
			case 'DVar':
				var _p4 = A2(_elm_community$list_extra$List_Extra_ops['!!'], ctx, _p3._0);
				if (_p4.ctor === 'Just') {
					return _user$project$Lambda$Var(_p4._0);
				} else {
					var newName = _user$project$Lambda$mkNewName(
						_elm_lang$core$List$length(ctx));
					return _user$project$Lambda$Var(newName);
				}
			case 'DApp':
				return A2(
					_user$project$Lambda$App,
					A2(_user$project$Lambda$toExpr, ctx, _p3._0),
					A2(_user$project$Lambda$toExpr, ctx, _p3._1));
			case 'DLam':
				var newName = _user$project$Lambda$mkNewName(
					_elm_lang$core$List$length(ctx));
				return A2(
					_user$project$Lambda$Lam,
					newName,
					A2(
						_user$project$Lambda$toExpr,
						{ctor: '::', _0: newName, _1: ctx},
						_p3._0));
			default:
				return _user$project$Lambda$Lit(_p3._0);
		}
	});
var _user$project$Lambda$DLit = function (a) {
	return {ctor: 'DLit', _0: a};
};
var _user$project$Lambda$DLam = function (a) {
	return {ctor: 'DLam', _0: a};
};
var _user$project$Lambda$DApp = F2(
	function (a, b) {
		return {ctor: 'DApp', _0: a, _1: b};
	});
var _user$project$Lambda$DVar = function (a) {
	return {ctor: 'DVar', _0: a};
};
var _user$project$Lambda$toDeBruijn = F3(
	function (depth, dict, e) {
		var _p5 = e;
		switch (_p5.ctor) {
			case 'Var':
				var _p6 = A2(_elm_lang$core$Dict$get, _p5._0, dict);
				if (_p6.ctor === 'Just') {
					return _elm_lang$core$Maybe$Just(
						_user$project$Lambda$DVar((depth - _p6._0) - 1));
				} else {
					return _elm_lang$core$Maybe$Just(
						_user$project$Lambda$DVar(99));
				}
			case 'App':
				return A2(
					_user$project$Lambda_ops['<*>'],
					A2(
						_user$project$Lambda_ops['<$>'],
						_user$project$Lambda$DApp,
						A3(_user$project$Lambda$toDeBruijn, depth, dict, _p5._0)),
					A3(_user$project$Lambda$toDeBruijn, depth, dict, _p5._1));
			case 'Lam':
				return A2(
					_user$project$Lambda_ops['<$>'],
					_user$project$Lambda$DLam,
					A3(
						_user$project$Lambda$toDeBruijn,
						depth + 1,
						A3(_elm_lang$core$Dict$insert, _p5._0, depth, dict),
						_p5._1));
			default:
				return _elm_lang$core$Maybe$Just(
					_user$project$Lambda$DLit(_p5._0));
		}
	});
var _user$project$Lambda$shift = F3(
	function (d, cutoff, term) {
		var _p7 = term;
		switch (_p7.ctor) {
			case 'DVar':
				var _p8 = _p7._0;
				return _user$project$Lambda$DVar(
					(_elm_lang$core$Native_Utils.cmp(_p8, cutoff) > -1) ? (_p8 + d) : _p8);
			case 'DLam':
				return _user$project$Lambda$DLam(
					A3(_user$project$Lambda$shift, d, cutoff + 1, _p7._0));
			case 'DApp':
				return A2(
					_user$project$Lambda$DApp,
					A3(_user$project$Lambda$shift, d, cutoff, _p7._0),
					A3(_user$project$Lambda$shift, d, cutoff, _p7._1));
			default:
				return _user$project$Lambda$DLit(_p7._0);
		}
	});
var _user$project$Lambda$substitute = F3(
	function (tgt, j, src) {
		var _p9 = tgt;
		switch (_p9.ctor) {
			case 'DVar':
				return _elm_lang$core$Native_Utils.eq(_p9._0, j) ? src : tgt;
			case 'DLam':
				return _user$project$Lambda$DLam(
					A3(
						_user$project$Lambda$substitute,
						_p9._0,
						j + 1,
						A3(_user$project$Lambda$shift, 1, 0, src)));
			case 'DApp':
				return A2(
					_user$project$Lambda$DApp,
					A3(_user$project$Lambda$substitute, _p9._0, j, src),
					A3(_user$project$Lambda$substitute, _p9._1, j, src));
			default:
				return _user$project$Lambda$DLit(_p9._0);
		}
	});
var _user$project$Lambda$deBruijnBeta = function (e) {
	var _p10 = e;
	switch (_p10.ctor) {
		case 'DApp':
			if (_p10._0.ctor === 'DLam') {
				return A3(
					_user$project$Lambda$shift,
					-1,
					0,
					A3(
						_user$project$Lambda$substitute,
						_p10._0._0,
						0,
						A3(_user$project$Lambda$shift, 1, 0, _p10._1)));
			} else {
				return A2(
					_user$project$Lambda$DApp,
					_user$project$Lambda$deBruijnBeta(_p10._0),
					_user$project$Lambda$deBruijnBeta(_p10._1));
			}
		case 'DLam':
			return _user$project$Lambda$DLam(
				_user$project$Lambda$deBruijnBeta(_p10._0));
...
var _user$project$Lambda$LBool = function (a) {
	return {ctor: 'LBool', _0: a};
};
var _user$project$Lambda$LInt = function (a) {
	return {ctor: 'LInt', _0: a};
};

var _user$project$Eval$parseAppend = F3(
	function (p, str, hist) {
		var _p0 = A2(_elm_tools$parser$Parser$run, p, str);
		if (_p0.ctor === 'Ok') {
			return {ctor: '::', _0: _p0._0, _1: hist};
		} else {
			return hist;
		}
	});
var _user$project$Eval$Finished = F2(
	function (a, b) {
		return {ctor: 'Finished', _0: a, _1: b};
	});
var _user$project$Eval$Intermediate = function (a) {
	return {ctor: 'Intermediate', _0: a};
};
var _user$project$Eval$Initial = function (a) {
	return {ctor: 'Initial', _0: a};
};
var _user$project$Eval$evalDB = F2(
	function (n, ex) {
		var newEx = _user$project$Lambda$deBruijnBeta(ex);
		return A2(_user$project$Lambda$equivalent, ex, newEx) ? {
			ctor: '::',
			_0: A2(_user$project$Eval$Finished, 'Reached normal form.', ex),
			_1: {ctor: '[]'}
		} : ((_elm_lang$core$Native_Utils.cmp(n, 200) > 0) ? {
			ctor: '::',
			_0: A2(_user$project$Eval$Finished, 'Ran out of time.', ex),
			_1: {ctor: '[]'}
		} : (_elm_lang$core$Native_Utils.eq(n, 0) ? {
			ctor: '::',
			_0: _user$project$Eval$Initial(ex),
			_1: A2(_user$project$Eval$evalDB, n + 1, newEx)
		} : {
			ctor: '::',
			_0: _user$project$Eval$Intermediate(ex),
			_1: A2(_user$project$Eval$evalDB, n + 1, newEx)
		}));
	});
var _user$project$Eval$parseEval = F2(
	function (p, str) {
		var _p1 = A2(_elm_tools$parser$Parser$run, p, str);
		if (_p1.ctor === 'Ok') {
			var _p2 = A3(_user$project$Lambda$toDeBruijn, 0, _elm_lang$core$Dict$empty, _p1._0);
			if (_p2.ctor === 'Just') {
				return A2(_user$project$Eval$evalDB, 0, _p2._0);
			} else {
				return {
					ctor: '::',
					_0: _user$project$Eval$Initial(
						_user$project$Lambda$DVar(666)),
					_1: {ctor: '[]'}
				};
			}
		} else {
...
var _user$project$Literals$factorial = 'Y (\\f. \\n. iszero n (\\g.\\x.g x) (times n (f (pred n)))) (\\g. \\x. g (g (g x)))';
var _user$project$Literals$times = A2(
	_user$project$Lambda$Lam,
	'm',
	A2(
		_user$project$Lambda$Lam,
		...
		A2(
			...
			A2(
				_user$project$Lambda$App,
				_user$project$Lambda$Var('m'),
				A2(
					_user$project$Lambda$App,
					_user$project$Lambda$Var('n'),
					_user$project$Lambda$Var('f'))))));
var _user$project$Literals$lamtrue = A2(
	_user$project$Lambda$Lam,
	'a',
	A2(
		_user$project$Lambda$Lam,
		'b',
		_user$project$Lambda$Var('a')));
var _user$project$Literals$lamfalse = A2(
	_user$project$Lambda$Lam,
	'a',
	A2(
		_user$project$Lambda$Lam,
		'b',
		_user$project$Lambda$Var('b')));
var _user$project$Literals$iszero = A2(
	_user$project$Lambda$Lam,
	'n',
	A2(
		_user$project$Lambda$App,
		A2(
			_user$project$Lambda$App,
			_user$project$Lambda$Var('n'),
			A2(_user$project$Lambda$Lam, 'x', _user$project$Literals$lamfalse)),
		_user$project$Literals$lamtrue));
var _user$project$Literals$pred = function () {
	var b = A2(
		_user$project$Lambda$Lam,
		'g',
		A2(
			...
			A2(
				_user$project$Lambda$App,
				_user$project$Lambda$Var('h'),
				A2(
					_user$project$Lambda$App,
					_user$project$Lambda$Var('g'),
					_user$project$Lambda$Var('f')))));
	var c = A2(
		_user$project$Lambda$Lam,
		'u',
		_user$project$Lambda$Var('x'));
	var d = A2(
		_user$project$Lambda$Lam,
		'u',
		_user$project$Lambda$Var('u'));
	return A2(
		_user$project$Lambda$Lam,
		'n',
		A2(
...
var _user$project$Literals$y = _user$project$Lambda$DLam(
	A2(
		_user$project$Lambda$DApp,
		_user$project$Lambda$DLam(
			A2(
				_user$project$Lambda$DApp,
				_user$project$Lambda$DVar(1),
				A2(
					_user$project$Lambda$DApp,
					_user$project$Lambda$DVar(0),
					_user$project$Lambda$DVar(0)))),
		_user$project$Lambda$DLam(
			A2(
				_user$project$Lambda$DApp,
				...
				A2(
					...
					_user$project$Lambda$DVar(0),
					_user$project$Lambda$DVar(0))))));
var _user$project$Literals$o = _user$project$Lambda$DLam(
	A2(
		_user$project$Lambda$DApp,
		_user$project$Lambda$DVar(0),
		_user$project$Lambda$DVar(0)));
var _user$project$Literals$x = _user$project$Lambda$DLam(
	A2(
		_user$project$Lambda$DApp,
		_user$project$Literals$o,
		_user$project$Lambda$DLam(
			A2(
				_user$project$Lambda$DApp,
				_user$project$Lambda$DVar(1),
				A2(
					...
					_user$project$Lambda$DVar(0),
					_user$project$Lambda$DVar(0))))));
var _user$project$Literals$s = _user$project$Lambda$DLam(
	_user$project$Lambda$DLam(
		_user$project$Lambda$DLam(
			A2(
				_user$project$Lambda$DApp,
				A2(
					_user$project$Lambda$DApp,
					_user$project$Lambda$DVar(2),
					_user$project$Lambda$DVar(0)),
				A2(
					_user$project$Lambda$DApp,
					_user$project$Lambda$DVar(1),
					_user$project$Lambda$DVar(0))))));
var _user$project$Literals$k = _user$project$Lambda$DLam(
	_user$project$Lambda$DLam(
		_user$project$Lambda$DVar(1)));
var _user$project$Literals$iota = _user$project$Lambda$DLam(
	A2(
		_user$project$Lambda$DApp,
		A2(
			_user$project$Lambda$DApp,
			_user$project$Lambda$DVar(0),
			_user$project$Literals$s),
		_user$project$Literals$k));
var _user$project$Literals$i = _user$project$Lambda$DLam(
	_user$project$Lambda$DVar(0));

var _user$project$ParseLambda$name = A2(
	_elm_tools$parser$Parser$keep,
	_elm_tools$parser$Parser$oneOrMore,
	function (x) {
		return _elm_lang$core$Char$isUpper(x) || _elm_lang$core$Char$isLower(x);
	});
var _user$project$ParseLambda$lint = A2(
	_elm_tools$parser$Parser_ops['|='],
	_elm_tools$parser$Parser$succeed(_user$project$Lambda$LInt),
	_elm_tools$parser$Parser$int);
var _user$project$ParseLambda$lfalse = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(
		_user$project$Lambda$LBool(false)),
	_elm_tools$parser$Parser$keyword('false'));
var _user$project$ParseLambda$ltrue = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(
		_user$project$Lambda$LBool(true)),
	_elm_tools$parser$Parser$keyword('true'));
var _user$project$ParseLambda$parsetimes = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(
		_user$project$Common$fromJust(
			A3(_user$project$Lambda$toDeBruijn, 0, _elm_lang$core$Dict$empty, _user$project$Literals$times))),
	_elm_tools$parser$Parser$keyword('times'));
var _user$project$ParseLambda$parseiszero = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(
		_user$project$Common$fromJust(
			A3(_user$project$Lambda$toDeBruijn, 0, _elm_lang$core$Dict$empty, _user$project$Literals$iszero))),
	_elm_tools$parser$Parser$keyword('iszero'));
var _user$project$ParseLambda$parsepred = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(
		_user$project$Common$fromJust(
			A3(_user$project$Lambda$toDeBruijn, 0, _elm_lang$core$Dict$empty, _user$project$Literals$pred))),
	_elm_tools$parser$Parser$keyword('pred'));
var _user$project$ParseLambda$ycomb = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(_user$project$Literals$y),
	_elm_tools$parser$Parser$keyword('Y'));
var _user$project$ParseLambda$icomb = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(_user$project$Literals$i),
	_elm_tools$parser$Parser$keyword('I'));
var _user$project$ParseLambda$kcomb = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(_user$project$Literals$k),
	_elm_tools$parser$Parser$keyword('K'));
var _user$project$ParseLambda$scomb = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$succeed(_user$project$Literals$s),
	_elm_tools$parser$Parser$keyword('S'));
var _user$project$ParseLambda$spaces = A2(
...
var _user$project$ParseLambda$prim = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		_elm_tools$parser$Parser$succeed(
		...
		_elm_tools$parser$Parser$oneOf(
			{
				ctor: '::',
				_0: _user$project$ParseLambda$scomb,
				_1: {
					ctor: '::',
					_0: _user$project$ParseLambda$kcomb,
					_1: {
						ctor: '::',
						_0: _user$project$ParseLambda$icomb,
						_1: {
							ctor: '::',
							_0: _user$project$ParseLambda$ycomb,
							_1: {
								ctor: '::',
								_0: _user$project$ParseLambda$parsepred,
								_1: {
									ctor: '::',
									_0: _user$project$ParseLambda$parseiszero,
									_1: {
										ctor: '::',
										_0: _user$project$ParseLambda$parsetimes,
										_1: {ctor: '[]'}
									}
								}
							}
	...
	_user$project$ParseLambda$spaces);
var _user$project$ParseLambda$lit = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		_elm_tools$parser$Parser$succeed(_user$project$Lambda$Lit),
		_elm_tools$parser$Parser$oneOf(
			{
				ctor: '::',
				_0: _user$project$ParseLambda$ltrue,
				_1: {
					ctor: '::',
					_0: _user$project$ParseLambda$lfalse,
					_1: {
						ctor: '::',
						_0: _user$project$ParseLambda$lint,
						_1: {ctor: '[]'}
					}
				}
			})),
	_user$project$ParseLambda$spaces);
var _user$project$ParseLambda$var = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		_elm_tools$parser$Parser$succeed(_user$project$Lambda$Var),
		_user$project$ParseLambda$name),
	_user$project$ParseLambda$spaces);
var _user$project$ParseLambda$parens = function (p) {
	return A2(
		_elm_tools$parser$Parser_ops['|.'],
		A2(
			_elm_tools$parser$Parser_ops['|.'],
...
var _user$project$ParseLambda$term = A2(
	_elm_tools$parser$Parser_ops['|.'],
	_elm_tools$parser$Parser$oneOf(
		{
			ctor: '::',
			_0: _user$project$ParseLambda$prim,
			_1: {
				ctor: '::',
				_0: _user$project$ParseLambda$lit,
				_1: {
					ctor: '::',
					_0: _user$project$ParseLambda$var,
					_1: {ctor: '[]'}
				}
			}
		}),
	_user$project$ParseLambda$spaces);
var _user$project$ParseLambda$app = function (_p0) {
	return _user$project$Common$fromJust(
		A2(_elm_community$list_extra$List_Extra$foldl1, _user$project$Lambda$App, _p0));
};
var _user$project$ParseLambda$expr = A2(
	_elm_tools$parser$Parser_ops['|='],
	_elm_tools$parser$Parser$succeed(_user$project$ParseLambda$app),
	A2(_elm_tools$parser$Parser$repeat, _elm_tools$parser$Parser$oneOrMore, _user$project$ParseLambda$term));
var _user$project$ParseLambda$lam = A2(
	_elm_tools$parser$Parser_ops['|.'],
	A2(
		_elm_tools$parser$Parser_ops['|='],
		A2(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_tools$parser$Parser_ops['|.'],
								_elm_tools$parser$Parser$succeed(_user$project$Lambda$Lam),
								_elm_tools$parser$Parser$oneOf(
									{
										ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: _elm_tools$parser$Parser$symbol('λ'),
											_1: {ctor: '[]'}
										}
									})),
							_user$project$ParseLambda$spaces),
			...
			_user$project$ParseLambda$spaces),
		_user$project$ParseLambda$expr),
	_user$project$ParseLambda$spaces);
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Submit') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					history: A2(_user$project$Eval$parseEval, _user$project$ParseLambda$expr, model.userInput),
					userInput: ''
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
...
var _user$project$Main$welcome = {
	ctor: '::',
	_0: A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('This is a lambda calculus interpreter. '),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html$text('It takes lambda calculus expressions and beta-reduces them. '),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text('It understands the S, K, I, and Y combinators, and iota. '),
					_1: {ctor: '[]'}
				}
			}
		}),
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('(\\x. \\y. x)'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('(\\f. (\\x. f (x x)) (\\x. f (x x)))'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('(\\f. f (\\x. \\y. \\z. x z (y z)) (\\x. \\y. x)) (\\f. f (\\x. \\y. \\z. x z (y z)) (\\x. \\y. x))'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('iota iota'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('S K K'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
...
var _user$project$Main$asColor = function (n) {
	var _p3 = A2(
		_elm_community$list_extra$List_Extra_ops['!!'],
		_user$project$Main$colors,
		A2(_elm_lang$core$Basics_ops['%'], n, 6));
	if (_p3.ctor === 'Just') {
		return _p3._0;
	} else {
		return 'rgb(0,0,0)';
...
var _user$project$Main$styleColorLv = function (l) {
	return _elm_lang$html$Html_Attributes$style(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'color',
				_1: _user$project$Main$asColor(l)
			},
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$renderExpr = F2(
	function (level, ex) {
		var _p4 = ex;
		switch (_p4.ctor) {
			case 'Var':
			...
			case 'App':
				if (_p4._1.ctor === 'App') {
					return A2(
						...
						{
							ctor: '::',
							_0: _user$project$Main$styleColorLv(level),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(_user$project$Main$renderExpr, level, _p4._0),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$Main$renderExpr,
										level + 1,
										A2(_user$project$Lambda$App, _p4._1._0, _p4._1._1)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(')'),
										_1: {ctor: '[]'}
					...
					return A2(
						...
						},
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$renderExpr, level, _p4._1),
									_1: {ctor: '[]'}
								}
							}
						});
					...
					},
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$Main$renderExpr, level + 1, _p4._1),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(')'),
										_1: {ctor: '[]'}
...
var _user$project$Main$mkLine = function (ex) {
	var _p5 = function () {
		var _p6 = ex;
		switch (_p6.ctor) {
			case 'Intermediate':
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: _p6._1,
					_1: A2(_elm_lang$core$Basics_ops['++'], _p6._0, ' | ')
				};
		}
	}();
	var e = _p5._0;
...
var _user$project$Main$showDeBruijn = function (ex) {
	var _p7 = ex;
	switch (_p7.ctor) {
		case 'DVar':
		...
		case 'DApp':
			if (_p7._1.ctor === 'DApp') {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Main$showDeBruijn(_p7._0),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' (',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Main$showDeBruijn(
								A2(_user$project$Lambda$DApp, _p7._1._0, _p7._1._1)),
							')')));
			} else {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						' ',
						_user$project$Main$showDeBruijn(_p7._1)));
			}
		case 'DLam':
			return A2(
				_elm_lang$core$Basics_ops['++'],
		...
		default:
			if (_p7._0.ctor === 'LInt') {
				return _elm_lang$core$Basics$toString(_p7._0._0);
			} else {
				return _elm_lang$core$Basics$toString(_p7._0._0);
			}
	}
};
var _user$project$Main$showExpr = function (ex) {
	var _p8 = ex;
	switch (_p8.ctor) {
		case 'Var':
			return _p8._0;
		case 'App':
			if (_p8._1.ctor === 'App') {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$Main$showExpr(_p8._0),
					A2(
						_elm_lang$core$Basics_ops['++'],
						' (',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Main$showExpr(
								A2(_user$project$Lambda$App, _p8._1._0, _p8._1._1)),
							')')));
			} else {
				return A2(
					_elm_lang$core$Basics_ops['++'],
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						' ',
						_user$project$Main$showExpr(_p8._1)));
			}
		case 'Lam':
			return A2(
				_elm_lang$core$Basics_ops['++'],
		...
		default:
			if (_p8._0.ctor === 'LInt') {
				return _elm_lang$core$Basics$toString(_p8._0._0);
			} else {
				return _elm_lang$core$Basics$toString(_p8._0._0);
			}
	}
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				_elm_lang$core$List$isEmpty(model.history) ? _user$project$Main$welcome : {
					ctor: '::',
					_0: _user$project$Main$mkLine(
						_user$project$Main$last(model.history)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
